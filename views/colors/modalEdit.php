                            ...
                            <?php 
                                foreach($users as $user){
                                    echo '<div class="form-check">
                                            <input class="form-check-input input-users" type="checkbox" id="edit-users-'.$user->id.'" name="users[]" value="'.$user->id.'">
                                            <label class="form-check-label d-flex" for="edit-users-'.$user->id.'">
                                                '.$user->name.'
                                            </label>
                                        </div>';
                                }
